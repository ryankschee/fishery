...
public final class CustomerSelectionTableModel
    extends AbstractTableModel {

    private final String[] columnNames = {"客户号码 / 名字"};
    private HashMap<String, CustomerBean> data;
    private List<CustomerBean> list;

    public CustomerSelectionTableModel(HashMap<String, CustomerBean> aMap) {
        setData( aMap );
    }
