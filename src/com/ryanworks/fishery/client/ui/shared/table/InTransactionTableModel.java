...
public class InTransactionTableModel
    extends AbstractTableModel {

    private String[] columnNames = {"id", "船户编号", "船户名字", "来货次数", "日期", "单据号码.", "总额"};
    ...
    public InTransactionTableModel(HashMap<String, InTransactionBean> aMap) 
    {
        setData( aMap );
    }
