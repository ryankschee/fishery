...
public class InTransactionLineTableModel
    extends AbstractTableModel {

    private String[] columnNames = {"id", "海鲜", "重量 (KG)", "客户", "桶号"};
    private HashMap<String, InTransactionLineBean> data;
    private List<InTransactionLineBean> list;

    public InTransactionLineTableModel(HashMap<String, InTransactionLineBean> aMap) 
    {
        setData( aMap );
    }
