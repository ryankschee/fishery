...
import com.ryanworks.fishery.client.ui.control.listener.SupplierWithdrawalEditorDialogListener;
 ...
 * @author Ryan C
 */
public class SupplierWithdrawalEditorDialog 
    extends javax.swing.JDialog 
{
    ...
    private SupplierWithdrawalBean withdrawalObj;
    private final SupplierWithdrawalEditorDialogListener listener;
     ...
     * @param cashBean
     */
    public SupplierWithdrawalEditorDialog(java.awt.Frame parent, boolean modal, SupplierWithdrawalEditorDialogListener listener, SupplierBean supplier, SupplierWithdrawalBean withdrawalObj) 
    {
        super(parent, modal);
        this.supplierObj = supplier;
        this.withdrawalObj = withdrawalObj;
    ...
    private void myInit()
    {
        if (this.withdrawalObj == null)
        {
            this.editingMode = EDITOR_MODE_NEW;
            this.withdrawalObj = new SupplierWithdrawalBean();
            this.withdrawalObj.setSupplierId( this.supplierObj.getId() );
        }
        else
        {
    ...
    {
        if (this.editingMode == SupplierWithdrawalEditorDialog.EDITOR_MODE_NEW)
        {
            this.jTextFieldId.setText( this.withdrawalObj.getId() );
            this.jTextFieldSupplierId.setText( this.withdrawalObj.getSupplierId() );
            this.jTextFieldDate.setText( MyDatePicker.SIMPLE_DATE_FORMAT.format(Calendar.getInstance().getTimeInMillis()) );
        }
        else
        if (this.editingMode == SupplierWithdrawalEditorDialog.EDITOR_MODE_EDIT)
        {
            this.jTextFieldId.setText( this.withdrawalObj.getId() );
            this.jTextFieldSupplierId.setText( this.withdrawalObj.getSupplierId() );
            this.jTextFieldDate.setText( MyDatePicker.SIMPLE_DATE_FORMAT.format(this.withdrawalObj.getCashDate()) );
            this.jTextFieldDesc.setText( this.withdrawalObj.getCashDesc());
            this.jTextFieldAmount.setText( twoPlacesFormatter.format( this.withdrawalObj.getCashAmount()) );
        }
    }
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        try 
        {
            ...
            this.withdrawalObj.setCashDate(dateInMillis);
            this.withdrawalObj.setCashDesc(this.jTextFieldDesc.getText().trim());
            this.withdrawalObj.setCashAmount(amount);
            
            this.listener.supplierWithdrawalEditorDialogClosed( this.withdrawalObj );
