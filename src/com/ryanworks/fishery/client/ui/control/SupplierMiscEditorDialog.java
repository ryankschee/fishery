...
import com.ryanworks.fishery.client.ui.control.listener.SupplierMiscEditorDialogListener;
 ...
 * @author Ryan C
 */
public class SupplierMiscEditorDialog 
    extends javax.swing.JDialog 
{
    ...
    private SupplierMiscBean miscObj;
    private final SupplierMiscEditorDialogListener listener;
     ...
     * @param miscBean
     */
    public SupplierMiscEditorDialog(java.awt.Frame parent, boolean modal, SupplierMiscEditorDialogListener listener, SupplierBean supplier, SupplierMiscBean miscBean) 
    {
        super(parent, modal);
        this.supplierObj = supplier;
        this.miscObj = miscBean;
    ...
    private void myInit()
    {
        if (this.miscObj == null)
        {
            this.editingMode = EDITOR_MODE_NEW;
            this.miscObj = new SupplierMiscBean();
            this.miscObj.setSupplierId( this.supplierObj.getId() );
        }
        else
        {
    ...
    {
        if (this.editingMode == SupplierMiscEditorDialog.EDITOR_MODE_NEW)
        {
            this.jTextFieldId.setText( this.miscObj.getId() );
            this.jTextFieldSupplierId.setText( this.miscObj.getSupplierId() );
            this.jTextFieldDate.setText( MyDatePicker.SIMPLE_DATE_FORMAT.format(Calendar.getInstance().getTimeInMillis()) );
        }
        else
        if (this.editingMode == SupplierMiscEditorDialog.EDITOR_MODE_EDIT)
        {
            this.jTextFieldId.setText( this.miscObj.getId() );
            this.jTextFieldSupplierId.setText( this.miscObj.getSupplierId() );
            this.jTextFieldDate.setText( MyDatePicker.SIMPLE_DATE_FORMAT.format(this.miscObj.getMiscDate()) );
            this.jTextFieldDesc.setText( this.miscObj.getMiscDesc());
            this.jTextFieldAmount.setText( twoPlacesFormatter.format( this.miscObj.getMiscAmount()) );
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "什费交易", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("KaiTi", 0, 18))); // NOI18N
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        try 
        {
            ...
            this.miscObj.setMiscDate(dateInMillis);
            this.miscObj.setMiscDesc(this.jTextFieldDesc.getText().trim());
            this.miscObj.setMiscAmount(amount);
            
            this.listener.supplierMiscEditorDialogClosed( this.miscObj );
